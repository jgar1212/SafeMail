...
import docker, psycopg2

app = Flask(__name__)
app.secret_key = "TOvjbmr#443.2nb"

# Postgres database connection
conn = psycopg2.connect(database="quarantine_db", user="postgres", password="root", host="localhost", port="5432")
cur = conn.cursor()
...
USER_FILE = "/home/ubuntu/docker-mailserver/docker-data/dms/config/postfix-accounts.cf"
